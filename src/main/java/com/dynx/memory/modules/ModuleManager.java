...
import com.dynx.memory.nativeapi.Kernel32Extended;
import com.dynx.memory.structures.ModuleEntry;
...
public class ModuleManager {
     ...
     * @throws DynxMemoryException if the module is not found or the snapshot fails
     */
     ...
     *
     * @param handle open process handle for the target process
     * @throws DynxMemoryException if the Toolhelp32 snapshot fails
     */
